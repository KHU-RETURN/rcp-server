...
func (_c *InstanceCreate) check() error {
	if _, ok := _c.mutation.OpenstackID(); !ok {
		return &ValidationError{Name: "openstack_id", err: errors.New(`internal: missing required field "Instance.openstack_id"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`internal: missing required field "Instance.name"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`internal: missing required field "Instance.status"`)}
	}
	if _, ok := _c.mutation.ImageID(); !ok {
		return &ValidationError{Name: "image_id", err: errors.New(`internal: missing required field "Instance.image_id"`)}
	}
	if _, ok := _c.mutation.FlavorID(); !ok {
		return &ValidationError{Name: "flavor_id", err: errors.New(`internal: missing required field "Instance.flavor_id"`)}
	}
	if _, ok := _c.mutation.ProviderCreatedAt(); !ok {
		return &ValidationError{Name: "provider_created_at", err: errors.New(`internal: missing required field "Instance.provider_created_at"`)}
	}
	if _, ok := _c.mutation.SyncState(); !ok {
		return &ValidationError{Name: "sync_state", err: errors.New(`internal: missing required field "Instance.sync_state"`)}
	}
	...
	if _, ok := _c.mutation.LastSyncedAt(); !ok {
		return &ValidationError{Name: "last_synced_at", err: errors.New(`internal: missing required field "Instance.last_synced_at"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`internal: missing required field "Instance.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`internal: missing required field "Instance.updated_at"`)}
	}
	if len(_c.mutation.OwnerIDs()) == 0 {
		return &ValidationError{Name: "owner", err: errors.New(`internal: missing required edge "Instance.owner"`)}
	}
	return nil
}
