...
// QueryInstance queries the instance edge of a App.
func (c *AppClient) QueryInstance(_m *App) *InstanceQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2O, true, app.InstanceTable, app.InstanceColumn),
		)
...
// QueryApp queries the app edge of a Instance.
func (c *InstanceClient) QueryApp(_m *Instance) *AppQuery {
